...
- Resolve principal documents per Agent Delegation Section 5.3 before relying on any delegation credential, and treat a document served away from its own `id` as carrying no controller binding.
